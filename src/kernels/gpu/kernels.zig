...
const KvAppendParams = extern struct { n_tokens: u32, n_kv_heads: u32, head_dim: u32, pos: u32, max_ctx: u32, kv_dtype: u32 };
...
comptime {
    ...
    std.debug.assert(@sizeOf(KvAppendParams) == 24);
    std.debug.assert(@sizeOf(GqaAttnParams) == 32);
